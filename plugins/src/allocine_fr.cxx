...
CFilm & allocine_fr::Detail (CFilm & Film)
{
    ...
    try
    {
        Temp = Extraire (Page, "Date de sortie : <b><a", "<").at(0);
    ...
    try
    {
        Temp = Extraire (Page, "<h3 class=\"SpProse\">Avec ", " &nbsp;&nbsp;<img").at (0);
    ...
    try
    {
        Temp = Extraire (Page, "Genre : ", "</h3>").at (0);
        while (Supprimer (Temp, Temp.find_first_of ('<'), 
                                Temp.find_first_of ('>')+1));
    ...
    try
    {
        Temp = Extraire (Page, "<h3 class=\"SpProse\">Dur", "&nbsp;</h3>").at (0);
